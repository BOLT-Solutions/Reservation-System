    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function Login() {
          ...
          this.authService.login(loginModel).then(function (user) {
            console.log("login status: ", user.status); //create user account with provided data

            console.log("user", user.data); // hide loading svg
        ...
        value: function Register() {
          ...
          this.AuthService.CustomerRegistration(model).subscribe(function (user) {
            ...
            if (user.succeeded) {
              ...
              _this16.router.navigateByUrl('/reservation');
            }
          }, function (error) {
            _this16.isLogging = false;
            console.log("error", error);
    ...
    function () {
      ...
      function formBuilderHelper(formBuilder) {
        ...
        this.controllers = {
          ...
          password: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern("^([a-zA-Z0-9@*#]{8,15})$")],
